...
import { classifyMinimalToolPlaneFailure, failureAttribution, infrastructureAnomalyLabels, } from "../infrastructure-failure.js";
...
test("classifies Bridge markers while rejecting unrelated execution errors", () => {
    ...
    assert.equal(classifyMinimalToolPlaneFailure(minimalHarness, "MINIMAL_TOOL_PLANE_COMPOSITION: preset Node does not match the Bridge runtime"), "minimal_tool_plane_composition");

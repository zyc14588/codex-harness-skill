...
```text
你是 codex-harness-skill 0.6.5 的独立严格验收者。先读取 release-status.json、MANIFEST_SHA256.txt、VALIDATION_REPORT_ZH.md、docs/05_ACCEPTANCE_ZH.md、docs/11_THINKING_POLICY_DESIGN_ZH.md、docs/12_SPLIT_MEMORY_SCHEMA4_MIGRATION_ZH.md 和 evidence/ 下的稳定版证据。

...
const steps = [
  ...
  { name: "credential-contract-tests", kind: "unique-test-suite", command: process.execPath, args: ["scripts/credential-contract.test.mjs"], cwd: options.root, timeout: 120_000 },
...
const evidence = {
  ...
  assertions: {
    ...
    disposableCredentialRevocationContract: executions.some((entry) => entry.name === "credential-contract-tests" && entry.result === "PASS"),

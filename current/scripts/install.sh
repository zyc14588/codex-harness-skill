...
for artifact in \
  ...
  bridge/dist/direct-acceptance.js bridge/dist/acceptance-client.js bridge/dist/brokered-tool-host.js \
  scripts/hash-tree.mjs scripts/verify-release-gate.mjs scripts/render-minimal-harness.py harness/minimal/profile/cordis.patch.yml harness/minimal/profile/bridge-brokered-tools.mjs harness/minimal/preset/agent.cordis.yml.in; do

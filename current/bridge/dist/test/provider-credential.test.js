...
import { CREDENTIAL_POLICY, CredentialRevocationNotObservedError, OFFICIAL_DEEPSEEK_MODELS_ENDPOINT, credentialFingerprintSha256, isCredentialRevocationStatus, waitForCredentialRevocation, } from "../provider-credential.js";
const binding = {
...
test("HTTP 429, 5xx, and other statuses time out fail closed", async () => {
    ...
    await assert.rejects(waitForCredentialRevocation({
        ...binding,
        ...
        delay: async (milliseconds) => { nowMs += milliseconds; },
        probe: async () => statuses.shift() ?? 0,
    }), (error) => error instanceof CredentialRevocationNotObservedError
...
//# sourceMappingURL=provider-credential.test.js.map
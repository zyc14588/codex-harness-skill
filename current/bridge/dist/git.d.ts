...
export declare function ignoredUntrackedPaths(worktreePath: string): Promise<string[]>;
...
export declare function createDetachedVerificationWorktree(repoRoot: string, worktreePath: string, baseCommit: string): Promise<void>;

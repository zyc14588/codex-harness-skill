...
0.6.6 延续并收紧 DeepSeek thinking 的 attempt 级不可变合同。同一 attempt 中，模型、thinking 模式和 reasoning effort 均不得切换。任何不一致都必须在 Provider 请求、Token 计量和 split-memory 学习之前失败。

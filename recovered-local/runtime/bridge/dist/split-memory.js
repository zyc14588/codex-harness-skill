...
export const SPLIT_MEMORY_SCHEMA_VERSION = 3;
...
function infrastructureAnomalies(task) {
    ...
    if (task.infrastructureFailureKind === "tool_protocol")
        anomalies.add("tool_protocol_failure");
    if (task.infrastructureFailureKind === "minimal_tool_plane")
        anomalies.add("minimal_tool_plane_failure");
    if (task.infrastructureFailureKind === "provider_transport")
        anomalies.add("provider_transport_failure");
    if (task.infrastructureFailureKind === "no_effect")
        anomalies.add("required_change_missing");

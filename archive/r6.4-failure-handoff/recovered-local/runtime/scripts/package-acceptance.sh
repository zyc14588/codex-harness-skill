...
args=sys.argv[1:]
if args in (["--version"],["-V"]): print("codex-fake 0.6.4"); raise SystemExit(0)
...
echo "[package 7/9] Reinstall accepted R6.4 after rollback"
...
print(json.dumps({
  "result":"PASS","version":"0.6.4","freshInstall":True,"installedAcceptance":True,
